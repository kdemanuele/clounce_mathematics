...
class SequenceSolver:
    ...
    def arithmetic_mean_sequence(sequence_start_value, sequence_end_value, variables):
        ...
        sequence_number = Sequences.jacobsthal_number(number_of_variables + 1)
        next_sequence_number = Sequences.jacobsthal_number(number_of_variables + 2)
        ...
        for i in range(1, number_of_variables):
            sequence_number = Sequences.jacobsthal_number(i + 1)
            next_sequence_number = Sequences.jacobsthal_number(i + 2)
    ...
    def arithmetic_mean_sequence_variable(sequence_start_value, sequence_end_value, number_of_variables, variable_to_solve):
        ...
        nth_jacobsthal = Sequences.jacobsthal_number(variable_to_solve + 1)
        pre_nth_jacobsthal = Sequences.jacobsthal_number(variable_to_solve)
        size_var_jacobsthal = Sequences.jacobsthal_number(number_of_variables + 1)
        next_size_var_jacobsthal = Sequences.jacobsthal_number(number_of_variables + 2)
