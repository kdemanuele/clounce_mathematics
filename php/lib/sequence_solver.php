...
class SequenceSolver {
    public static function ArithmeticMeanSequence($sequenceStartValue, $sequenceEndValue, array &$variables) {
        ...
        $sequenceNumber = Sequences::jacobsthalNumber($numberOfVariables + 1);
        $nextSequenceNumber = Sequences::jacobsthalNumber($numberOfVariables + 2);
    ...
    public static function arithmeticMeanSequenceVariable($sequenceStartValue, $sequenceEndValue, int $numberOfVariables, int $variableToSolve) {
        ...
        $nthJacobsthal = Sequences::jacobsthalNumber($variableToSolve + 1);
        $preNthJacobsthal = Sequences::jacobsthalNumber($variableToSolve);
        $sizeVarJacobsthal = Sequences::jacobsthalNumber($numberOfVariables + 1);
        $nextSizeVarJacobsthal = Sequences::jacobsthalNumber($numberOfVariables + 2);
